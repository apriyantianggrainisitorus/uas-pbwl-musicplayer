...
<body>
	...
	<table>
		...
		<div class="col-sm-5">
			<input type="text" name="tracks_name" value="{{ $rows->tracks_name}}" style="background-color:PapayaWhip; color: black" class="form-control" id="inputEmail3">
		</div>
		</div>
		<div class="form-group row">
		...
		<div class="col-sm-5">
			<select name="album_id" class="form-control" style="background-color: PapayaWhip; color: black">
		...
		<div class="col-sm-5">
			<input type="text" name="tracks_time" value="{{ $rows->tracks_time}}" style="background-color: PapayaWhip; color: black" class="form-control" id="inputEmail3">
		</div>
		</div>
	</table>
			<div class="form-group row">
